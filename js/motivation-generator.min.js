function motgen_load_image(b){function e(){a=new Image;a.id="motgen_raw_background_picture";a.src=h.result;a.style.display="none";for(var b=document.getElementById("motgen_raw_background_placeholder");b.firstChild;)b.removeChild(b.firstChild);b.insertBefore(a,b.firstChild);a.onload=m}function m(){function b(d,c){f.fillStyle="#000000";f.fillRect(0,0,g.width,g.height);var k,e=0;a.height>a.width?(k=parseInt(a.height/90),e=parseInt(a.height/167)):(k=parseInt(a.width/90),e=parseInt(a.width/167));11>k&&
...
isNaN(c)&&(c=60);isNaN(e)&&(e=60);(function(b){g.style.position="inherit";g.width=1<a.width/a.height?a.width+a.width/5:a.width+a.width/3;g.height=a.height+(2*c+e)+a.height/10+c/2;b()})(function(){var c=g.width/2-a.width/2;b(c,function(){h(c,function(){g.style.display="block";document.getElementById("motgen_generator_form").style.display="block";d.style.display="none"})})})}function c(b){for(var a=document.getElementById("motgen_error_message_area");a.firstChild;)a.removeChild(a.firstChild);var c=
document.createElement("p");c.innerHTML=b;a.appendChild(c);a.style.display="block"}var d=document.getElementById("motgen_loading_icon");d.style.display="inline";var g=document.getElementById("motgen_poster_canvas"),f=g.getContext("2d");g.style.display="none";if(2===b){var a=document.getElementById("motgen_raw_background_picture");m()}else{var h;if("function"!==typeof window.FileReader)c("Hey, Your browser seems out of date.");else if(b=document.getElementById("motgen_imgfile"))if(b.files)if(b.files[0])if(b.files[0].type.match("image.*"))document.getElementById("motgen_error_message_area").style.display=
